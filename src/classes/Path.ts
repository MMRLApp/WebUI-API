...
export class Path {
  ...
  public constructor(public cwd: string | undefined) {
    this.cwd = cwd;
  }
  ...
  public basename(path: string, ext: string) {
  ...
  public format(pathObject: PathObject) {
  ...
  public parse(path: string) {
    ...
    var ret: PathObject = { root: "", dir: "", base: "", ext: "", name: "" };
